...
<body id="top" class="subscribe">
		...
		<div id="content" class="wrapper clear">
			<div id="body-wrapper" class="clearfix" style="margin:120px auto 0 auto; width:50%; background:rgba(255,255,255,.9); padding:20px; box-shadow:0 0 20px rgba(0,0,0,.1);	border-radius:5px;">
