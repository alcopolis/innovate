		...
		<div class="content">
			...
			<div class="tabs">
				<ul class="tab-menu">
					...
					<li><a href="#epg-import"><span>Import EPG</span></a></li>
				</ul>
				...
				<div class="form_inputs" id="epg-import">
					<?php echo form_open_multipart('admin/epg/shows/import_csv', 'id="product-form"'); ?>
						<fieldset>
							<ul>
								<li>
									<label for="csvdata">Select EPG File (<span style="font-size:10px;">CSV format</span>)</label>
